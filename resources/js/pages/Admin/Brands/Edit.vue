...
const form = useForm({
    ...
    categories: props.brand.categories.map((c) => c.id),
});

const existingLogo = computed(() => props.brand.logo_url);
...
function submit() {
    form.put(admin.brands.update.url(props.brand.id), {
        preserveScroll: true,
        onSuccess: () => {
...
<template>
    ...
    <AppLayout
        :breadcrumbs="[
            ...
            { title: 'Edit', href: admin.brands.edit.url(brand.id) },
        ]"
    >
                        ...
                        <div class="grid gap-4 md:grid-cols-2">
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="flex items-center gap-4">
                                    <div
                                        v-if="previewUrl || (existingLogo && !form.logo)"
